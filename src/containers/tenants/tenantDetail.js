        ...
        <>
            <View style={styles.container}>
                ...
                <ScrollView style={{marginTop: 30}}>
                        ...
                        <View style={{flexDirection: 'row', marginLeft: 10}}>
                            ...
                            <View style={{marginLeft: 15, alignSelf: 'center'}}>
                                ...
                                <View style={{flexDirection: 'row', marginLeft: 10}}>
                                    ...
                                    <Text style={{color: '#ffffff80', fontSize: 16, fontWeight: '500', marginLeft: 5}}>(555) 555-5555</Text>
                                </View>
                                {/* Email Address */}
                    ...
                    <TouchableOpacity style={{backgroundColor: 'red', marginTop: 50, marginHorizontal: 30, padding: 15, borderRadius: 10}} onPress={deleteAlert}>
