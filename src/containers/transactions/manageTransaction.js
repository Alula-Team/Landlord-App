       ...
       <>
            <View style={styles.container}>
                ...
                <ScrollView>
                    ...
                    <View style={styles.propertySectionSpacing}>
                        <Text style={{color: '#34383D80', fontSize: 15, fontWeight: '600', marginBottom: 20}}>Receipt:</Text>
                        <TouchableOpacity style={{ marginBottom: 30, marginTop: 20}}>
                            <Image style={{ height: 200, width: 200, borderRadius: 10}} source={require('../../assets/receipt.jpg')} />
                        </TouchableOpacity>
                    </View>
